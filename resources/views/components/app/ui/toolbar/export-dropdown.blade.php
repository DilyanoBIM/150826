<!-- resources/views/components/app/ui/toolbar/export-dropdown.blade.php -->
<div x-data="{ open: false }" class="relative inline-block text-left">
    ...
    <div x-show="open"
         ...
         class="absolute right-0 z-50 mt-2 w-44 origin-top-right rounded-lg bg-white shadow-lg ring-1 ring-slate-200 focus:outline-none"
         style="display: none;">
        <div class="py-1">
